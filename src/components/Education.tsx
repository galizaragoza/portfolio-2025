      ...
      <div>
        ...
        <div>
          ...
          <p className="text-xl md:text-xl text-gray-800 text-end font-semibold">
            Máster en Desarrollo Full-Stack de Nuclio Digital School (octubre
            2023 – marzo 2024), que cursé de forma intensiva y online cubriendo
            conocimientos de front y back end. Aprendí y apliqué tecnologías
            clave —React, JavaScript (HTML, CSS y Tailwind), Node.js, WebSockets
            y MongoDB— y profundicé en protocolos web, buenas prácticas de
            código y seguridad en el desarrollo. Trabajé bajo metodologías
            ágiles (SCRUM) y utilicé flujos de versión con Git y procesos de
            integración continua/entrega continua (CI/CD). Gracias a los
            proyectos prácticos, reforcé mis habilidades de comunicación,
            adaptabilidad, trabajo en equipo y mediación, desarrollando
            soluciones reales de principio a fin y colaborando eficazmente con
            mis compañeros para garantizar la calidad y escalabilidad de las
            aplicaciones.
          </p>
        </div>
